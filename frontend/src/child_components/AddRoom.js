...
import {Button,Modal,Input,InputNumber,Checkbox,Row,Col,Upload,Divider,Typography} from 'antd';
...
<Col span={12} style={{display:"flex",alignItems:"center",gap:"30px"}}>
