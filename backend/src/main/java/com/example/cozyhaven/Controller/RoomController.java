...
public class RoomController {
    ...
    public ResponseEntity<?> searchAvailableRooms(
        ...
        List<RoomDTO> rooms
                = service.searchAvailableRooms(hotelId);
    ...
    public ResponseEntity<?> updateRoomById(
        ...
        RoomDTO updatedRoom
                = service.updateRoomById(id, room);
